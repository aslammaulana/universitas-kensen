                ...
                {SiswaJson.map(data => (
                    <div key={data.id} className='mb-[15px] font-medium flex flex-col'>
                        <div className='bg-[#2f3a4d] text-[#FFFFFFCF] py-[20px] pr-[20px] pl-[20px]  justify-between items-center rounded-lg text-[12px]'>
                            <div className='mb-5'>
                                <button className={`bg-[${data.status === "Tuntas" ? "#68b37849" : "#b3686849"}] text-[${data.status === "Tuntas" ? "#7fe294" : "#f09c9c"}] text-[12px] font-medium py-2 px-5 rounded-full`}>
                            ...
                            <div className='mt-5'>
                                <div className="flex space-x-2 justify-center items-center">
                                    <button className="justify-center bg-[#3d67b1] hover:bg-[#413ca1] text-white text-[12px] font-medium w-full py-2.5 px-3 rounded-md inline-flex items-center ">
                ...
                {SiswaJson.map(data => (
                    <div key={data.id} className='mb-[15px] font-medium'>
                        <div className='bg-[#2f3a4d] text-[#FFFFFFCF] py-[20px] pr-[20px] pl-[30px] flex grid-cols-6 justify-between items-center rounded-lg text-[12px]'>
                            ...
                            <div className='w-[24%]'>
                                <div className="flex space-x-2 justify-center items-center">
                                    <button className="justify-center bg-[#3d67b1] hover:bg-[#2d508b] text-white text-[12px] font-medium py-2.5 px-3 rounded-md inline-flex w-full items-center">
                                        <HiEye size={15} className='fill-current w-4 h-4 mr-1' />
                                        <span>Lihat</span>
                                    </button>
